...
namespace Modules.Identity.Entities.Migrations
{
    ...
    [Migration("20260116220618_workspace")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Identity.Entities.DbSchemas.Workspace", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("Workspaces", "Idp");
                });

            modelBuilder.Entity("Modules.Identity.Entities.DbSchemas.WorkspaceUser", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("WorkspaceUsers", "Idp");
                });

            modelBuilder.Entity("Modules.Identity.Entities.DbSchemas.RoleClaim", b =>
                {
                    b.HasOne("Modules.Identity.Entities.DbSchemas.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Modules.Identity.Entities.DbSchemas.UserClaim", b =>
                {
                    b.HasOne("Modules.Identity.Entities.DbSchemas.User", null)
                        .WithMany()
